            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="btn-group" role="group" aria-label="Action area">
                        ...
                        <a href="{{ route('admin.damageStock.index') }}" class="btn btn-primary" title="Refresh">
                            <i class="fa fa-refresh" aria-hidden="true"></i>
                        </a>
    
                        <a href="{{ route('admin.stock.index') }}" class="btn btn-success" title="Show all product.">
                        ...
                        @foreach($damage_stocks as $key => $damage)
                            <div class="card">
                                <div class="card-header d-flex justify-content-between align-items-center" id="warehouse-{{ $loop->index }}">
                                    ...
                                    <div class="btn-group" role="group" aria-label="Action area">
                                        {{-- <a href="{{ route('admin.damageStock.edit', $damage_stocks->id) }}" class="btn btn-primary" title="Edit product quantity.">
