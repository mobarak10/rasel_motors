	...
	<div class="row">
		...
		<div class="col-md-4 mb-3">
			<div class="card">
				...
				<ul class="list-group list-group-flush">
					...
					<li class="list-group-item">
						<small class="d-block">Employee of Shop</small>
				...
				<div class="card-body">
					<a href="{{ route('admin.employee.edit', $record->id) }}" class="card-link">Change</a>
					<a href="{{ route('admin.employee.changeEmployeeStatus', $record->id) }}" class="card-link">
		...
		<div class="col-md-8">
			<ul class="nav nav-tabs" role="tablist">
				...
				<li class="nav-item">
					<a class="nav-link" data-toggle="tab" href="#profile-role" role="tab" aria-controls="role" aria-selected="false">Roles</a>
				</li>
			...
			<div class="tab-content">
				...
				<div class="tab-pane fade" id="profile-role" role="tabpanel" aria-labelledby="role-tab">
					<div class="accordion" id="roleLists">
						@forelse($record->roles as $role)
							<h4 class="py-2">{{ $role->name }}</h4>
							<div class="ml-3">
								@forelse($role->permissions as $permission)
									<span class="badge badge-primary px-2 py-1 rounded-0" title="{{ $permission->description }}">{{ $permission->name }}</span>
								@empty
