                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item">Dealer Price: {{ $product->dealer_price }}</li>
                                    <li class="list-group-item">Cash Customer Price: {{ $product->cash_customer_price }}</li>
                                    <li class="list-group-item">Sub Dealer Price: {{ $product->sub_dealer_price }}</li>
                                    <li class="list-group-item">Semi Credit Price: {{ $product->semi_credit_price }}</li>
                                    <li class="list-group-item">Semi Cash Customer Price: {{ $product->semi_cash_customer_price }}</li>
                                    <li class="list-group-item">Regular Credit Price: {{ $product->regular_credit_price }}</li>
                                    <li class="list-group-item">One Third Customer Price: {{ $product->one_third_customer_price }}</li>
                                </ul>
                            </div>
                        </div>
                    </div>
