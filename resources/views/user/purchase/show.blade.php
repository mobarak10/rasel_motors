                    ...
                    <div class="row align-items-center">
                        <div class="col-12">
                            ...
                            <div class="total text-right">
                                ...
                                <div class="single">
                                    Previous Balance <span>{{ number_format(abs($purchase->previous_balance), 2) }} {{ $purchase->previous_balance > 0 ? 'Rec' : 'Pay' }}</span>
                                </div>

                                <div class="single">
                                    Due <span>{{ number_format($purchase->total_due, 2) }}</span>
                                </div>
                            </div>
                            <!-- End of the total -->
                        </div>
