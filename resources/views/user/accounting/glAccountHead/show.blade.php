                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="btn-group" role="group" aria-label="Action area">
                            <a href="{{ route('glAccountHead.index') }}" class="btn btn-primary" title="All bank">
                    ...
                    <div class="card-body">
                        <article>
                            ...
                            <p>
                                ...
                                <strong><a href="{{ route('glAccount.show', $gl_head->glAccount->id) }}">{{ $gl_head->glAccount->name }}</a></strong> 
                                @lang('contents.type')
